            ...
            <table width="100%" id="datatablesSimple" class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    if (isset($_POST['submit'])) {
                        ...
                        $filter = mysqli_query($db, "SELECT * FROM daily_recovered WHERE Sembuh_Harian BETWEEN '$dt_tgl' AND '$smp_tgl' ");
                    } else {
                        $filter = mysqli_query($db, "SELECT * FROM `daily_recovered`");
                    }
                    ...
                    <tr class="text-center">
                        <td><?php echo $no++; ?></td>
                        <td><?php echo $row['Sembuh_Harian']; ?></td>
