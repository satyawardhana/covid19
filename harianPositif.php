            ...
            <table width="100%" id="datatablesSimple" class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    if (isset($_POST['submit'])) {
                        ...
                        $filter = mysqli_query($db, "SELECT * FROM total_positif_case WHERE Total_Kasus BETWEEN '$dt_tgl' AND '$smp_tgl' ");
                    } else {
