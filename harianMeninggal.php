...
<body>
    ...
    <section class="p-3" style="background-color:#800000;">
        ...
        <div class="table-responsive" style="overflow-x:auto;">
            <table width="100%" id="datatablesSimple" class="text-white table table-hover">
                ...
                <tbody>
                    ...
                    if (isset($_POST['submit'])) {
                        ...
                        $filter = mysqli_query($db, "SELECT * FROM daily_casualties WHERE Meninggal_Harian BETWEEN '$dt_tgl' AND '$smp_tgl' ");
                    } else {
                        $filter = mysqli_query($db, "SELECT * FROM `daily_casualties`");
                    }
                    ...
                    <tr class="text-center">
                        <td><?php echo $no++; ?></td>
                        <td><?php echo $row['Meninggal_Harian']; ?></td>
